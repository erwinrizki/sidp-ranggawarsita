  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="hero-unit">
		...
		<center>
        <form method="POST" action="prosesupdatemember.php">
		<table border="0" cellspacing="40">
			<?php
				include "koneksi.php";
				
				$id = $_GET['id'];
				$tampil = "SELECT * FROM data_petugas WHERE id='$id';";
				$querytampil = mysql_query($tampil);
				$hasil = mysql_fetch_array($querytampil);
				$nama = $hasil['nama'];
				$usern = $hasil['username'];
				$pass = $hasil['password'];
			?>
			<tr>
				<td>Nama Petugas</td>
			...
			<tr>
				<td>Username</td>
				<td>:</td>
				<td><input name="username" type="text" id="username" size="15" value="<?php echo $usern; ?>" /></td>
			</tr>
			<tr>
				<td>Password</td>
				<td>:</td>
